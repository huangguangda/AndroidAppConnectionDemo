...
public class ItemVideoAdapter extends RecyclerView.Adapter<ItemVideoAdapter.ViewHolder>{
    ...
    @Override
    public ItemVideoAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ItemVideoAdapter.ViewHolder holder, int position) {
